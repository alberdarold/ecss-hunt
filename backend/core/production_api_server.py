...
from ecss_foundation_system import ECSSFoundationSystem, FoundationConfig, SearchResult, IngestionResult
from ecss_batch_ingestion import ECSSBatchIngestion, BatchIngestionConfig
    ...
    def _register_routes(self, app: Flask):
        ...
        def search():
            ...
            try:
                ...
                # Filter visual content if requested
                if not include_visual:
                    results = [r for r in results if not r.is_visual_content]
                ...
                if self.config.use_colpali:
                    try:
                        ...
                        if response and response.completion:
                            contextual_response = response.completion
