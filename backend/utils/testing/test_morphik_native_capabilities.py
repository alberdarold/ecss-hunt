...
from ingestion.experimental.morphik_native_visual_processor import MorphikNativeVisualProcessor
from ingestion.experimental.morphik_native_simplified_ingestion import MorphikNativeECSSIngestion
...
def main():
    ...
    if visual_success and ingestion_success:
        ...
        print("\n📋 Next steps:")
        print("   1. Use ingestion.experimental.morphik_native_simplified_ingestion.py to ingest documents")
        print("   2. Use ingestion.experimental.morphik_native_visual_processor.py for analysis")
