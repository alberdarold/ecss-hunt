...
def fix_env_paths():
    ...
    for subdir in directories:
        ...
        for py_file in subdir_path.glob("*.py"):
            ...
            new_dotenv_pattern = 'load_dotenv(dotenv_path=Path(__file__).parent.parent.parent / "config" / ".env")'
            ...
            new_dotenv_pattern2 = 'load_dotenv(dotenv_path=Path(__file__).parent.parent.parent / "config" / ".env")'
            ...
            new_morphik_pattern = 'Path(__file__).parent.parent.parent / "config" / "morphik.toml"'
            ...
            new_morphik_pattern2 = 'str(Path(__file__).parent.parent.parent / "config" / "morphik.toml")'
