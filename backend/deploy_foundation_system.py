...
def test_foundation_system():
    ...
    try:
        ...
        from production_api_server import ProductionAPIServer, FoundationConfig
...
def display_deployment_instructions():
    ...
    print("   - Or if using the core directory directly: python core/production_api_server.py")
    print()
