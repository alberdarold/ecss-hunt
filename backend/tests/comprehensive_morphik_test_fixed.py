...
#!/usr/bin/env python3
"""
Comprehensive Morphik Testing Script - FIXED VERSION
...
class ComprehensiveMorphikTest:
    ...
    def get_document_id(self, doc):
        """Get document ID using external_id."""
    ...
    def test_2_simple_text_ingestion(self):
        ...
        try:
            ...
            # Get document ID
            doc_id = self.get_document_id(doc)
            if not doc_id:
            ...
            chunks = self.db.retrieve_chunks(query="requirements", document_id=doc_id)
    ...
    def test_3_simple_metadata_extraction(self):
        ...
        try:
            ...
            print(f"✅ Text ingested with metadata rule")
            ...
            # Re-fetch document
            try:
                refetched = self.db.get_document(doc_id)
    ...
    def test_4_natural_language_rule(self):
        ...
        try:
            ...
            print(f"✅ Text ingested with NL rule")
    ...
    def test_5_pdf_processing(self):
        ...
        try:
            # Find a small PDF file - use correct path
            ...
            chunks = self.db.retrieve_chunks(query="ECSS", document_id=doc_id)
            print(f"✅ Retrieved {len(chunks)} chunks")
    ...
    def test_6_pdf_with_metadata_rules(self):
        ...
        try:
            ...
            # Find a small PDF - use correct path
            pdf_dir = Path("../ECSS Published Standards/1-Active Standards")
            pdf_files = list(pdf_dir.glob("*.pdf"))
            ...
            print(f"✅ PDF ingested with metadata rule")
    ...
    def run_all_tests(self):
        ...
        print("🚀 Starting Comprehensive Morphik Testing - FIXED VERSION")
        print("=" * 60)
    ...
    def generate_report(self):
        ...
        report_file = f"comprehensive_test_results_fixed_{timestamp}.json"
